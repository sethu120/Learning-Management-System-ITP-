                                ...
                                <Grid item direction={"column"} lg={9} md={8} xs={12}>
                                    <FormControl fullWidth>
                                        ...
                                        <Select
                                            ...
                                            fullWidth
                                        >
                                            <MenuItem key={1} value={"45 Minutes"}>45 Minutes</MenuItem>
                                            <MenuItem key={2} value={"1 Hour"}>1 Hour</MenuItem>
                                            <MenuItem key={3} value={"3 Hours"}>3 Hours</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                            ...
                            <Grid container direction={"row"} pb={2} px={5}
                                ...
                                >
                                    <Button type={"submit"} variant={"contained"}
                                            sx={{padding: "10px", backgroundColor: "#00B74A"}}>Create</Button>
                                </Grid>
